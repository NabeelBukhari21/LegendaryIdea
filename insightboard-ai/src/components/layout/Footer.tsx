            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="text-muted text-sm leading-relaxed max-w-md">
                            A privacy-first classroom learning copilot. Empowering teachers with aggregated insights and students with personalized support — without surveillance.
                        </p>
                    </div>
                ...
                <div className="mt-12 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <p className="text-xs text-muted">
                        © 2026 InsightBoard AI. Learning support, not surveillance.
                    </p>
