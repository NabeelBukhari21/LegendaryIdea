                        ...
                        <div>
                            ...
                            <div className="glass-card p-5 bg-accent/[0.03] border-accent/15 mb-4">
                                <p className="text-base font-bold text-foreground leading-relaxed mb-2">
                                    &ldquo;{advice?.pattern || fallbackPersonalPattern.pattern}&rdquo;
                                </p>
                                <p className="text-sm text-muted leading-relaxed">
                                    {advice?.advice || fallbackPersonalPattern.description}
                                </p>
                            ...
                            <div className="glass-card p-4 bg-success/5 border-success/15">
                                <div className="flex items-start gap-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-foreground leading-relaxed">{fallbackPersonalPattern.suggestion}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
